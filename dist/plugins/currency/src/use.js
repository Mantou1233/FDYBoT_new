...
const handlers_1 = __importDefault(require("../assets/handlers"));
/**
 * @returns void
 */
async function load(client, cm) {
    ...
    cm.register({
        ...
        handler: async (msg, { prefix }) => {
            ...
            if (!handlers_1.default.equip[p.equip.rod]?.remove)
                throw new Error("Handler not found.");
            await handlers_1.default.equip[p.equip.rod].remove(msg, p);
        }
    });
}
