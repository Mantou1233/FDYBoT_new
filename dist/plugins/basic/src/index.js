            ...
            msg.channel.send({
                embeds: [
                    new Discord.EmbedBuilder()
                        .setColor("#CFF2FF")
                        .setTitle(`FDYbot ${"1.6"} ${process.env.BUILD.toLowerCase()}`)
