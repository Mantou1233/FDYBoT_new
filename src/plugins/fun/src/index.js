...
async function load(client, cm) {
    ...
    cm.register({
        ...
        handler: async msg => {
            ...
            const response = await axios.get(
                "https://shitpostgen.herokuapp.com/?count=200"
            );
            msg.reply({
                embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .setFooter(
                            "text generated from https://shitpostgen.herokuapp.com i do not own any of the texts generated."
                        )
                        .setColor("#CFF2FF")
                ]
            });
    ...
    cm.register({
        ...
        handler: async msg => {
            ...
            const response = await axios.get(
                `https://www.htmlcsscolor.com/hex/${color.toUpperCase()}`
            );
            ...
            var desc2 = response.data
                .split(
                    '<p id="cntMain_lblInformation" style="text-align:justify"><p style="text-align:justify">'
                )[1]
                .split("</div>")[0]
                .trim();
    ...
    cm.register({
        ...
        handler: async msg => {
            ...
            if (target.username.toLowerCase().includes("paketa")) result = 690;
    ...
    cm.register({
        ...
        handler: async msg => {
            ...
            let color = 42.5;
            let limit = 6;
            if (args[1]) color = parseFloat(args[1]);
            if (color === NaN) color = 42.5;

            if (args[2]) limit = args[1] * 1;
            if (limit === NaN) limit = 6;
    ...
    cm.register({
        ...
        handler: async msg => {
            ...
            await Canvas.loadImage(
                "https://cdn.discordapp.com/attachments/817751130494205962/961104382559129600/2e7e5867f2a106ca.png"
            ).then(image => {
